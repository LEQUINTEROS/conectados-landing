...
const steps = [
  {
    number: '01',
    title: 'Acercamos la IA de forma comprensible',
    description: 'Traducimos la complejidad tecnológica en lenguaje claro. Explicamos qué es, para qué sirve y cómo cualquier persona puede usarla en su vida cotidiana.',
    icon: (
  ...
  {
    number: '02',
    title: 'Generamos aprendizaje colectivo',
    description: 'Creamos espacios de formación grupal donde las personas aprenden haciendo, preguntan sin miedo y avanzan juntas. La comunidad es nuestro método.',
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  {
    number: '03',
    title: 'Conectamos formación con oportunidades',
    description: 'Vinculamos lo aprendido con salidas reales: empleo, emprendimiento, proyectos comunitarios. El conocimiento solo transforma si se convierte en acción.',
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  {
    number: '04',
    title: 'Construimos comunidad y futuro',
    description: 'Cada persona que aprende se convierte en un nodo más de una red que crece. Construimos un tejido colectivo que sostiene y amplifica el impacto.',
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
        ...
        <div ref={ref} className={`reveal ${visible ? 'visible' : ''}`}>
          ...
          <div className="text-center max-w-3xl mx-auto mb-20">
            ...
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-display font-extrabold text-white leading-tight">
              Un camino claro,
              <br />
              <span className="text-turquesa-300">paso a paso</span>
            </h2>
          </div>
