...
const pillars = [
  {
    ...
    title: 'Formación accesible en IA',
    description: 'Talleres y programas formativos diseñados para personas sin experiencia tecnológica previa. Aprender inteligencia artificial no debería depender de tu código postal, tu edad ni tu situación económica.',
    accent: 'violeta',
  },
  {
    icon: (
    ...
    description: 'Espacios donde aprender juntos, compartir dudas y crecer en colectivo. Porque la tecnología se entiende mejor cuando se aprende en compañía y con acompañamiento humano real.',
    accent: 'turquesa',
  },
  {
    icon: (
    ...
    title: 'Activación de oportunidades',
        ...
        <div ref={ref} className={`reveal ${visible ? 'visible' : ''}`}>
          ...
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-lg text-gray-600 leading-relaxed">
              No se trata solo de enseñar herramientas. Se trata de abrir oportunidades
              reales, construir comunidad y poner la tecnología al servicio de la dignidad.
            </p>
          </div>
