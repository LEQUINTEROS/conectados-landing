  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 legal-content">
        ...
        <p>CONECTADOS, responsable del sitio web, en adelante RESPONSABLE, pone a disposición de los usuarios el presente documento, con el que pretende dar cumplimiento a las obligaciones dispuestas en la Ley 34/2002, de 11 de julio, de Servicios de la Sociedad de la Información y de Comercio Electrónico (LSSICE), BOE N.º 166, así como informar a todos los usuarios del sitio web respecto a cuáles son las condiciones de uso.</p>
        <p>Toda persona que acceda a este sitio web asume el papel de usuario, comprometiéndose a la observancia y cumplimiento riguroso de las disposiciones aquí dispuestas, así como a cualquier otra disposición legal que fuera de aplicación.</p>
        <p>CONECTADOS se reserva el derecho de modificar cualquier tipo de información que pudiera aparecer en el sitio web, sin que exista obligación de preavisar o poner en conocimiento de los usuarios dichas obligaciones, entendiéndose como suficiente la publicación en el sitio web de CONECTADOS.</p>

        <h2>1. Datos identificativos</h2>
        <ul>
          <li><strong>Nombre de dominio:</strong> www.asociacionconectados.org/</li>
          <li><strong>Nombre comercial:</strong> Asociación Conectados</li>
          <li><strong>Denominación social:</strong> CONECTADOS</li>
          <li><strong>NIF:</strong> G75578229</li>
          <li><strong>Domicilio social:</strong> CALLE MARGARITA RETUERTO, NUM 2 PLANTA 3, PUERTA A PALMA DE MALLORCA</li>
          <li><strong>Teléfono:</strong> +34 871717535</li>
          <li><strong>E-mail:</strong> dpd@asociaciónconectados.org</li>
        </ul>
        ...
        <p>Para realizar cualquier tipo de observación respecto a posibles incumplimientos de los derechos de propiedad intelectual o industrial, así como sobre cualquiera de los contenidos del sitio web, puede hacerlo a través del correo electrónico contacto@asociaciónconectados.org.</p>
